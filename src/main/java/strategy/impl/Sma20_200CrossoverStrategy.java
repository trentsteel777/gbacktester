...
@AutoLoadStrategy
public class Sma20_200CrossoverStrategy extends Strategy {

    public Sma20_200CrossoverStrategy(String symbol) {
        super(symbol);
    }
    ...
    public void run(Map<String, StockPrice> marketData) {
        ...
        if (Objects.isNull(sp.getSma20()) || Objects.isNull(sp.getSma200())) {
            return; 
        }
    ...
    private boolean isBullishCross(StockPrice sp) {
        if (sp.getSma20() == null || sp.getSma200() == null) {
            return false;
        }
        return sp.getSma20() > sp.getSma200();
    }
